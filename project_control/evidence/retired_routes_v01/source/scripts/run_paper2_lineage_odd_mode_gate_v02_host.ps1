...
$containerName = "prl-paper2-lineage-odd-mode-gate-v02-20260909"
...
$runnerHash = "54f07dfdb1b51286c129ec41404e31945492532e1346fc5728893b06b17f752a"
$resultDirectory = Join-Path $ProjectRoot "results\paper2_lineage_odd_mode_gate\v02_20260909"
...
if ($LASTEXITCODE -ne 0 -or $desktopStatus -notmatch "running") {
    throw "Docker Desktop is not running; P1 remains BLOCKED/NOT_RUN"
}
...
$createArguments = @(
    ...
    "--entrypoint", "python3",
    $imageName,
    "/workspace/scripts/run_paper2_lineage_odd_mode_gate_v02.py",
...
if (-not $finishedWithinBudget) {
    ...
    throw "formal P1 attempt exceeded the independent 60-second watchdog"
}
...
Write-Output "P1 container exit code: $containerExitCode"
