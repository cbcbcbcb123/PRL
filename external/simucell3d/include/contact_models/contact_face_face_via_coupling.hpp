...
class contact_face_face_via_coupling: public contact_model_abstract{
    ...
    private:
        // cos(90 degrees).  A literal keeps this a C++17 constant expression
        // on compilers where std::cos is not constexpr (notably MSVC).
        static constexpr double max_dot_product_adhesion_  = 0.0;
