"""Create-only CPU runner for the frozen Z1-BIOFORM-MYO-A v02 contract."""
...
CONTRACT = PROJECT_ROOT / "project_control" / "ventricle_bioform_myocardium_free_state_contract_v02.md"
AUTHORIZATION = PROJECT_ROOT / "project_control" / "ventricle_bioform_myocardium_free_state_authorization_v02.md"
SOURCE = PROJECT_ROOT / "src" / "ventricle_bioform_myo" / "ventricle_bioform_myo.cpp"
...
EXECUTABLE = PROJECT_ROOT / "b" / "z1_bioform_myo" / "Release" / "prl_ventricle_bioform_myo.exe"
...
VERIFIER = PROJECT_ROOT / "scripts" / "verify_ventricle_z1_bioform_myo_v02.py"
RENDERER = PROJECT_ROOT / "scripts" / "render_ventricle_z1_bioform_myo_v02.py"
TEST_SOURCE = PROJECT_ROOT / "tests" / "test_ventricle_z1_bioform_myo_v02.py"
FROZEN_FILES = (
    CONTRACT,
    AUTHORIZATION,
    SOURCE,
